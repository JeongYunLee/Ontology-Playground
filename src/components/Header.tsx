...
export function Header({ onAboutClick, onHelpClick, onDataSourcesClick, onImportExportClick, onGalleryClick, onDesignerClick, onLearnClick, onNLBuilderClick, onSummaryClick }: HeaderProps) {
  ...
  const shareLabel = shareStatus === 'copied' ? t('header.shareCopied') : shareStatus === 'downloaded' ? t('header.shareDownloaded') : shareStatus === 'copying' ? t('common.loading') : t('header.share');
    ...
    <header className="header">
      ...
      <div className="header-actions">
        <button
          ...
          onClick={handleShare}
          title={shareableId ? t('header.shareTooltipCopy') : t('header.shareTooltip')}
        ...
        <button className="header-text-btn" onClick={onSummaryClick} title={t('header.summaryTooltip')}>
          <FileText size={16} />
        ...
        <button className="icon-btn" onClick={onLearnClick} data-tooltip={t('header.ontologySchool')} aria-label={t('header.ontologySchool')}>
          <BookOpen size={20} />
        </button>
        ...
        {menuOpen && (
          <div className="mobile-menu-dropdown">
            ...
            <button className="mobile-menu-item" onClick={menuAction(onLearnClick)}>
              <BookOpen size={18} /> {t('header.ontologySchool')}
            </button>
